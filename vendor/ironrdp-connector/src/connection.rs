            ...
            optional_data: ClientCoreOptionalData {
                ...
                early_capability_flags: {
                    let mut early_capability_flags = ClientEarlyCapabilityFlags::VALID_CONNECTION_TYPE
                        ...
                        // mdrdp patch: without this the server never offers the graphics
                        // dynamic virtual channel, so EGFX cannot open at all. Measured:
                        // drdynvc joins, then nothing. See vendor/README.md.
